  ...
  case nb.PageIndex of
    0:
      begin
        ...
        begin
          eMVC.ToolBox.showInfo('Please give a set name.');
          exit;
        end;
        if SetNameExists(edtSetName.Text) then
        begin
          eMVC.ToolBox.showInfo('Sorrry,the set named "' + edtSetName.Text + '" already exists!');
          exit;
        end;
...
//      nb.PageIndex := 3;
    ...
    begin
      ...
      btnOKNext.Caption := '&Finish';
    end
    else begin
      btnOKNext.ModalResult := mrNone;
      btnOKNext.Caption := '&Next';
    end;
  end;
